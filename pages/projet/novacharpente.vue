<template>
    <div>
      ...
      p1="Le projet a commencé par une phase de conception, au cours de laquelle l'équipe de Novadigital a travaillé en étroite collaboration avec Novacharpente pour comprendre leurs besoins et leurs exigences. En utilisant leur expertise en matière de design et de développement, ils ont créé un site web qui reflète l'identité de marque de Novacharpente et qui est facile à naviguer pour les visiteurs."
      p2="Ensuite, l'équipe de développement de Novadigital a pris en charge la phase de développement du site. Ils ont utilisé les dernières technologies pour créer un site web moderne, rapide et entièrement fonctionnel. Le site a été développé sur mesure pour répondre aux besoins spécifiques de Novacharpente."
  
      />
      <ProjetDeuxieme
      image ="/img/novacharpente/novacharpente3.png"
      title="Référencement local "
      p1="Une fois le site vitrine développé, l'équipe de Novadigital a travaillé sur l'optimisation du référencement SEO pour assurer la visibilité du site sur les moteurs de recherche. Ils ont utilisé des techniques de SEO local pour aider Novacharpente à se classer en tête des résultats de recherche locaux pour les mots clés pertinents tels que 'charpente', 'couverture' et 'menuiserie'."
     />
      <ProjetDeuxieme
      image ="/img/novacharpente/novacharpente4.png"
      title="Pourquoi choisir notre agence web novadigital"
