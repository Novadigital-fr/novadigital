<template>
    <div>
      ...
      />
      <ProjetPresentation
      projetReveal="Novadigital est une agence web spécialisée dans la création d'applications mobiles sur mesure. Nous sommes fiers de présenter notre dernière création : Novalinguo, une application mobile conçue pour aider les utilisateurs à apprendre l'anglais en discutant avec d'autres personnes sur des sujets variés. Novalinguo est une application mobile développée en utilisant Flutter, une technologie open-source de développement d'applications multi-plateformes. Cette technologie permet de créer des applications mobiles avec une interface utilisateur attrayante et une expérience utilisateur fluide."
      />
      <ProjetDeuxieme
      image ="/img/novalingo/novalingo2.png"
      title ="création de l'application mobile"
      p1="Chez Novadigital, nous avons mis l'accent sur la création d'une application mobile qui soit à la fois fonctionnelle et esthétiquement plaisante. Nous avons donc conçu une interface utilisateur élégante et moderne qui offre une expérience utilisateur agréable et intuitive."
      p2="La création d'applications mobiles sur mesure est notre cœur de métier chez Novadigital. Nous sommes passionnés par la création d'applications mobiles uniques qui répondent aux besoins de nos clients et qui offrent une expérience utilisateur optimale. Novalinguo est un excellent exemple de notre savoir-faire en matière de développement d'applications mobiles sur mesure."
  
      />
      <ProjetDeuxieme
      image ="/img/novalingo/novalingo3.png"
      title="Optimisation sur les stores"
     ...
     />
      <ProjetDeuxieme
      image ="/img/novalingo/novalingo4.png"
      title="En conclusion"
      ...
      p2="Nous sommes une agence web passionnée par la création d'applications mobiles sur mesure, et nous sommes fiers de proposer à nos clients des solutions innovantes et de haute qualité. Nous sommes convaincus que Novalinguo est une application mobile de haute qualité qui répondra aux besoins des utilisateurs les plus exigeants."
        ...
        p4="En résumé, Novalinguo est une application mobile de haute qualité conçue par Novadigital en utilisant la technologie Flutter. Cette application offre une solution pratique et conviviale pour apprendre l'anglais en discutant avec d'autres personnes sur des sujets variés. Chez Novadigital, nous sommes fiers de proposer des solutions innovantes et de haute qualité pour nos clients, et nous sommes convaincus que Novalinguo sera une application mobile très populaire et utile pour de nombreuses personnes."
      />
